...
The flow towards the well can be calculated as $q = 2 \pi r K \frac{\partial h}{\partial r}$ (the typical negative sign in Darcy's law is removed because we are calculating flow in the direction of negative r). We can run this calculation and plot flow towards the aquifer. Note that closer to the pump this calculation suffers from discretization of the domain causing the flowrate to diverge from 1 ft^3^/s.
